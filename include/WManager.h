...
public:
    ...
    /**
     * Allows objects to register for a call of their update() method. This
     * enables objects to update their values right before they are rendered.
     ...
     * update() for that object; this is to ensure that updates depending on
     * each other through object relations will not fail due to silently
     * modified order.
     */
