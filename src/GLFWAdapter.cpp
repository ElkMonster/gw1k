...
StateEvent glfwToGw1kStateEvent(int glfwStateEvent)
{
    ...
    case GLFW_REPEAT: return GW1K_REPEATED;
    case GLFW_RELEASE:
    default:
...
int glfwToGw1kKeyCodes(int glfwKey)
{
    ...
    case GLFW_KEY_ESCAPE: return GW1K_KEY_ESC;
    ...
    case GLFW_KEY_LEFT_SHIFT: return GW1K_KEY_LSHIFT;
    case GLFW_KEY_RIGHT_SHIFT: return GW1K_KEY_RSHIFT;
    case GLFW_KEY_LEFT_CONTROL: return GW1K_KEY_LCTRL;
    case GLFW_KEY_RIGHT_CONTROL: return GW1K_KEY_RCTRL;
    case GLFW_KEY_LEFT_ALT: return GW1K_KEY_LALT;
    case GLFW_KEY_RIGHT_ALT: return GW1K_KEY_RALT;
#ifndef GW1K_GLFW_IS_VERSION_2_6
    case GLFW_KEY_LEFT_SUPER: return GW1K_KEY_LSUPER;
    case GLFW_KEY_RIGHT_SUPER: return GW1K_KEY_RSUPER;
#endif
    ...
    case GLFW_KEY_DELETE: return GW1K_KEY_DEL;
    case GLFW_KEY_PAGE_UP: return GW1K_KEY_PAGEUP;
    case GLFW_KEY_PAGE_DOWN: return GW1K_KEY_PAGEDOWN;
...
#ifndef GW1K_GLFW_IS_VERSION_2_6
    case GLFW_KEY_NUM_LOCK: return GW1K_KEY_KP_NUM_LOCK;
